...
var gobletSquat = new MakeWorkout('Goblet Squats', 'Lower', 'Beginner', true, false, 'glutes', 'https://www.youtube.com/watch?v=mF5tnEBrdkc', 'Another variation of the squat that works most of the lower body, and can be done with a variety of different styles of weights.');
...
function getFormData (event) {
  ...
  genUserWorkout();
  window.location = 'workout_generator_result.html';
}
