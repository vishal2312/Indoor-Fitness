...
function createWorkoutPage() {
  ...
  resultsPage = [{'name': 'CRISSCROSS', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'}, 
                 {'name': 'CRUNCH', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'Plank', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'SIT UP', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'PUSH THROUGH', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'FLUTTER KICKS', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},]
  bringName();
