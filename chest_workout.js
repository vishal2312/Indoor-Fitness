...
function createWorkoutPage() {
  ...
  resultsPage = [{'name': 'STRETCH WALK', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'}, 
                 {'name': 'BROCK DRILL', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'COBRA TRICEPS EXTENSION', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'PLANK TAP', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'FULL BRIDGE', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'TORSO ELEVATED PUSHUP', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},]
  bringName();
