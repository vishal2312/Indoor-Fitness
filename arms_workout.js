...
function createWorkoutPage() {
  ...
  resultsPage = [{'name': 'TRICEPS BENCH DIPS', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'}, 
                 {'name': 'STANDARD PUSHUPS', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'PLANK TAP', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'ARCHER LUNGES', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'DYNAMIC CHEST STRETCH', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},
                 {'name': 'ARM LEG RAISES', 'img': 'https://www.youtube.com/embed/gG2Z1siSvkk', 'descr': 'test'},]
  bringName();
